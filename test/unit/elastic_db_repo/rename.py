...
"""Program:  rename.py
    ...
    Description:  Unit testing of rename in elastic_db_repo.py.
...
class UnitTest(unittest.TestCase):
    ...
    def test_delete_err_false(self):
        ...
        self.assertFalse(elastic_db_repo.rename(self.els, self.name_list))
    ...
    def test_delete_err_true(self):
        ...
        with gen_libs.no_std_out():
            self.assertFalse(
                elastic_db_repo.rename(self.els, self.name_list2))
    ...
    def test_create_err_false(self):
        ...
        self.assertFalse(elastic_db_repo.rename(self.els, self.name_list3))
    ...
    def test_create_err_true(self):
        ...
        with gen_libs.no_std_out():
            self.assertFalse(
                elastic_db_repo.rename(self.els, self.name_list4))
